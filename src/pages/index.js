  ...
  return (
    ...
    crossorigin="anonymous" />
      ...
      <Container type="content" className="text-center home-start">
        ...
        COVID-19 has had a global impact, with the disease affecting people across all sections of society. In a testing time like this, mental health is also increasingly becoming a concern, especially with social isolation becoming key to defeat COVID-19.
        </p>
        <p style={{textAlign: "justify", marginTop: "1vh", marginBottom: "2vh"}}> The purpose of this platform is to provide a demonstration of the insights that our <a href="https://github.com/ketanjog/COVIDSentimentAnalysis">COVIDSentiment NLP</a> platform is capable of generating, on live twitter data. The end goal of COVIDSentiment is to create a live NLP based platform that is capable of understanding social media sentiment on both a macro, as well as a micro scale, in order to help those whose mental health is adversely affected by COVID-19.
        </p>
